...
int radius1 = 146; // the size of the circle 2 average energy in Atlas building times 60
int radius2 = 172; // the size of the circle 3 average productivity in Atlas building times 60
...
int[] segments = {2*8, 7*8, 3*8, 1*8, 1*8}; // Number of vertical segments per color based on the individual data of creativity in Atlas times a number to creat a full circle
...
void draw() {
  ...
  save("auditorium.jpg");// saving the screen as a picture
}
