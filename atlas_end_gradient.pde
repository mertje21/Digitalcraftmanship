...
int radius = 230; // the size of the circle 1
int radius1 = 230; // the size of the circle 2
int radius2 = 214; // the size of the circle 3 average times 60
...
int[] segments = {0*5, 1*5, 3*5, 11*5, 7*5}; // Number of vertical segments for creativity
int[] segments1 = {0*5,1*5, 5*5, 13*5, 3*5}; // Number of vertical segments for energy
int[] segments2 = {1*4, 0*5, 9*4, 8*4, 4*4}; // Number of vertical segments for productivity
void setup() {
  size(1700, 500);
  noLoop();
}
